...
var _Leaf = __webpack_require__(26);
    ...
    value: function render() {
      ...
      if (this.state.ctx) {
        ...
        return _react2.default.createElement(
          ...
          null,
          _react2.default.createElement('canvas', { ref: 'canvas', width: '1920', height: '1080' }),
          this.state.leaves.map(function (leaf) {
            return _react2.default.createElement(_Leaf2.default, { x: leaf.x, y: leaf.y, ctx: _this2.state.ctx });
          })
        );
      } else {
        console.log("falsy");
        return _react2.default.createElement('canvas', { ref: 'canvas', width: '1920', height: '1080' });
        //return null
      }
    }
  }]);
